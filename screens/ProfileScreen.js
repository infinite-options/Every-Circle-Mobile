...
const ProfileScreen = ({ route, navigation }) => {
  ...
  const processUserData = (apiUser, extractedProfileUID, extractedEmail) => {
    try {
      ...
      try {
        userData.experience = apiUser.experience_info && typeof apiUser.experience_info === 'string' 
          ? JSON.parse(apiUser.experience_info) 
          : (Array.isArray(apiUser.experience_info) ? apiUser.experience_info : []);
      } catch (e) {
      ...
      try {
        userData.education = apiUser.education_info && typeof apiUser.education_info === 'string' 
          ? JSON.parse(apiUser.education_info) 
          : (Array.isArray(apiUser.education_info) ? apiUser.education_info : []);
      } catch (e) {
      ...
      try {
        userData.expertise = apiUser.expertise_info && typeof apiUser.expertise_info === 'string' 
          ? JSON.parse(apiUser.expertise_info) 
          : (Array.isArray(apiUser.expertise_info) ? apiUser.expertise_info : []);
      } catch (e) {
      ...
      try {
        userData.wishes = apiUser.wishes_info && typeof apiUser.wishes_info === 'string' 
          ? JSON.parse(apiUser.wishes_info) 
          : (Array.isArray(apiUser.wishes_info) ? apiUser.wishes_info : []);
      } catch (e) {
      ...
      try {
        const socialLinks = apiUser.social_links && typeof apiUser.social_links === 'string' 
          ? JSON.parse(apiUser.social_links) 
          : (typeof apiUser.social_links === 'object' ? apiUser.social_links : {});
      ...
      <ScrollView style={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('EditProfile', { user: user, profile_uid: profileUID })}>
